...
public class JsonPathDirectextract {

    @Test
    void approach6_JsonPathDirect() {
        ...
        Assert.assertEquals(json.getString("data.userDetails.phoneNumbers[0].type"), "home");
        ...
        Assert.assertEquals(json.getInt("data.recentOrders[1].items.size()"), 1);
